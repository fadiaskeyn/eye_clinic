                                    ...
                                    <tr>
                                        <form action="/{{auth()->user()->level}}/penjualan/store" method="POST">
                                            @csrf
                                                    ...
                                                    {{--  <td>{{$loop->iteration}}<input class="form-control" type="text"
                                                    value="{{$pasien}}" name="pasien" hidden></td>

                                                    <td>{{$loop->iteration}}<input class="form-control" type="text"
                                                    value="{{$diagnosa}}" name="diagnosa" hidden>
                                                </td>  --}}
                                            ...
                                            <td hidden>{{$item->formatRupiah('harga')}}
                                                <input class="form-control"
                                                    type="text" value="{{$item->harga}}" name="harga" hidden>
                                                </td>
{{--
                                                    <td>{{$item->kode}}<input class="form-control" type="text"
                                                        value="{{$item->id}}" name="barang_id" hidden></td>  --}}
